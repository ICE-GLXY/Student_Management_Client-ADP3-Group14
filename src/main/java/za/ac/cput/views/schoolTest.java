...
import static za.ac.cput.requests.schoolRequest.*;
...
public class schoolTest extends JFrame  {
    ...
    private void initComponents() {
        ...
        emailLbl.setText("School ID :");

        gradeLbl.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        gradeLbl.setText("Name :");

        schoolTxt.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        schoolNameTxt.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(emailLbl, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(schoolTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(schoolTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(gradeLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(schoolNameTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(57, 57, 57)
        ...
        deleteHeadLbl.setText("Delete A School");
    ...
    private void showTable()
    {
        ...
        List schoolList = getAll();
        List<school>school = schoolList;
        ...
        for(int i = 0; i <schoolList.size(); i++){
            dtModel.addRow(
                    new Object[] {
                            school.get(i).getSchoolCode(),
                            school.get(i).getSchoolName(),
                    }
            );
        }
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        {
            save_school(schoolTxt.getText(), schoolNameTxt.getText());
        }
    }
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == deleteBtn)
            {
                deleteSchool(schoolIdTxt.getText());
            }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(schoolTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
